...
void draw_scene(SDL_Instance instance, Player_POV *player, char *map[MAP_WIDTH][MAP_HEIGHT]);
/* Draw the maze */
...
int check_horizontal_intersections(int *horizontal_coords, int ray_angle, Player_POV *player, char *map[MAP_WIDTH][MAP_HEIGHT]);
/* Return coords of closest vertical intersection of ray and wall */
int *check_vertical_intersections(int ray_angle, Player_POV *player, char *map[MAP_WIDTH][MAP_HEIGHT]);
